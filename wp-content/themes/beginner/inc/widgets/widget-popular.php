 ...
 * @since      1.0.0
 */
class Beginner_Popular_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-beginner-popular widget_posts_thumbnail',
			'description' => __( 'Display popular posts by comments with thumbnails.', 'beginner' )
		);

		// Create the widget.
		parent::__construct(
			'beginner-popular',                                   // $this->id_base
			__( '&raquo; Popular Posts Thumbnails', 'beginner' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		if ( false === ( $popular = get_transient( 'beginner_popular_widget_' . $this->id ) ) ) {
			...
			// Store the transient.
			set_transient( 'beginner_popular_widget_' . $this->id, $popular );
	...
	function flush_widget_transient() {
		delete_transient( 'beginner_popular_widget_' . $this->id );
	}
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Popular Posts', 'beginner' ),
			'limit'     => 5,
			'show_date' => false
		);
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>">
				<?php _e( 'Number of posts to show', 'beginner' ); ?>
			</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_date' ); ?>">
				<?php _e( 'Display post date?', 'beginner' ); ?>
			</label>
		</p>
