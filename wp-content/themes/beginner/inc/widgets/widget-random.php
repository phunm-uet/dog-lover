 ...
 * @since      1.0.0
 */
class Beginner_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-beginner-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'beginner' )
		);

		// Create the widget.
		parent::__construct(
			'beginner-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'beginner' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'beginner' ),
			'limit'     => 5,
			'show_date' => false
		);
