 ...
 * @since      1.0.0
 */
class Beginner_Ads125_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( 'Easily to display any type of ad.', 'beginner' )
		);

		// Create the widget.
		parent::__construct(
			'beginner-ad125',                                  // $this->id_base
			__( '&raquo; Advertisement 125x125', 'beginner' ), // $this->name
