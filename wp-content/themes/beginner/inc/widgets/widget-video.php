 ...
 * @since      1.0.0
 */
class Beginner_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-beginner-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'beginner' )
		);

		// Create the widget.
		parent::__construct(
			'beginner-video',                  // $this->id_base
			__( '&raquo; Video', 'beginner' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'beginner' ),
			'video_url'  => '',
			'video_code' => ''
		);
