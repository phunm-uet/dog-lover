 ...
 * @since      1.0.0
 */
class Beginner_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-beginner-ad widget_ads',
			'description' => __( 'Easily to display any type of ad.', 'beginner' )
		);

		// Create the widget.
		parent::__construct(
			'beginner-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'beginner' ), // $this->name
