 ...
 * @since      1.0.0
 */
class Beginner_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-beginner-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'beginner' )
		);

		// Create the widget.
		parent::__construct(
			'beginner-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'beginner' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow us', 'beginner' ),
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
