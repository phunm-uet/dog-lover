...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Text Fonts', 'beginner' ) ) ) );
	$text_fonts     = customizer_library_get_text_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'beginner' ) ) ) );
	 ...
	 */
	return apply_filters( 'customizer_library_all_fonts', array_merge( $heading1, $text_fonts, $heading2, $google_fonts ) );
}
endif;
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'beginner' ),
		'cyrillic'     => __( 'Cyrillic', 'beginner' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'beginner' ),
		'devanagari'   => __( 'Devanagari', 'beginner' ),
		'greek'        => __( 'Greek', 'beginner' ),
		'greek-ext'    => __( 'Greek Extended', 'beginner' ),
		'khmer'        => __( 'Khmer', 'beginner' ),
		'latin'        => __( 'Latin', 'beginner' ),
		'latin-ext'    => __( 'Latin Extended', 'beginner' ),
		'vietnamese'   => __( 'Vietnamese', 'beginner' ),
	);
}
endif;
...
if ( ! function_exists( 'customizer_library_get_text_fonts' ) ) :
/**
 * Return an array of text websafe fonts.
 *
 * @since  1.0.0.
 *
 * @return array    Text websafe fonts.
 */
function customizer_library_get_text_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'beginner' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'beginner' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'beginner' ),
