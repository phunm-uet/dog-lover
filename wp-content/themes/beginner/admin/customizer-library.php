...
// Custom controls for the theme customizer.
	if ( version_compare( $GLOBALS['wp_version'], '4.0', '<' ) ) {
		require plugin_dir_path( __FILE__ ) . 'controls/textarea.php';
	}
	require plugin_dir_path( __FILE__ ) . 'controls/editor.php';
	require plugin_dir_path( __FILE__ ) . 'controls/date.php';
	require plugin_dir_path( __FILE__ ) . 'controls/buttonset.php';
	require plugin_dir_path( __FILE__ ) . 'controls/switch.php';
	require plugin_dir_path( __FILE__ ) . 'controls/number.php';
	require plugin_dir_path( __FILE__ ) . 'controls/select.php';
	require plugin_dir_path( __FILE__ ) . 'controls/multiple-select.php';
	require plugin_dir_path( __FILE__ ) . 'controls/group-title.php';
