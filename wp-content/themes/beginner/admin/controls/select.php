<?php
/**
 * The select2 customize control extends the WP_Customize_Control class.  This class allows 
 ...
 * @since  1.0.0
 */
class Customizer_Library_Select extends WP_Customize_Control {
	...
	/**
	 * Displays the select2 on the customize screen.
	 */
	public function render_content() { 
		...
		<label>
			...
			<select class="select2" <?php $this->link(); ?> style="width: 100%">
				<?php
