...
class OPanda_AdvancedSettings extends OPanda_Settings  {
    ...
    public function getOptions() {
        ...
        $forms[] = array(
            ...
            'hint'      => __( 'By default if the blurring or transparent mode is used, the content may be visible during a short time before the locker appears. On other side, the classic mode is used, the locked content is hidden by default on loading. Change this option to manage content visibility when a page loads.', 'bizpanda' )
        );
