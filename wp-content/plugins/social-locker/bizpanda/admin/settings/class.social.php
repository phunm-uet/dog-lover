...
class OPanda_SocialSettings extends OPanda_Settings  {
    ...
    public function getOptions() {
        ...
        $options[] = array(
            ...
            'hint'      => __( 'Optional. Use the most recent version of the API (v2.6) but if Facebook buttons or widgets don\'t work on your website try to switch to other versions.', 'bizpanda' )
        );
