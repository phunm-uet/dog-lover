...
<div class="onp-help-section">
    <p><?php printf( __('1. Open the website <a href="%s" target="_blank">developers.facebook.com</a> and click "Add a New App":', 'bizpanda'), 'https://developers.facebook.com/' ) ?></p>
    <p class='onp-img'>
...
<div class="onp-help-section">
    <p><?php _e('9. Move to the section "App Review":', 'bizpanda' ) ?></p>
    <p class='onp-img'>
