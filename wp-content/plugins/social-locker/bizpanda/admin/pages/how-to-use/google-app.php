...
<div class="onp-help-section">
    <p><?php _e('4. Click "Enable and manage APIs":', 'bizpanda' ) ?></p>
    <p class='onp-img'>
...
<div class="onp-help-section">
    <p><?php _e('6. In the sidebar on the left, select "Credentials" and create new credentials "OAuth client ID"', 'bizpanda' ) ?></p>
    <p class='onp-img'>
